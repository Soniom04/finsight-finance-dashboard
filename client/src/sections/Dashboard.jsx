      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
        <div className='grid xl:grid-cols-2 grid-cols-1 gap-4'>
          <MoneyCard title={"Total Balance"} amount={statistic.balance}
            icon={"$"} style={"text-emerald-600"} textColor={statistic.balance >= 0 ? "text-emerald-500" : "text-red-500"} />
          <MoneyCard title={"Monthly Income"} amount={statistic.income} icon={"+"} style={"text-indigo-500"} />
        </div>
        ...
        <div className='grid xl:grid-cols-2 grid-cols-1 gap-4'>
          ...
          amount={statistic.savingRate + "%"} textColor={statistic.savingRate >= 0 ? "text-emerald-500" : "text-red-500"}
